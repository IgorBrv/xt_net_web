	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			while (true)
			{
				...
				Output.Print("b", "g", $"\n ПРОГРАММА, КОТОРАЯ ОПРЕДЕЛЯЕТ СУММУ НЕОТРИЦАТЕЛЬНЫХ ЭЛЕМЕНТОВ В МАССИВЕ".PadRight(100) + "\n\n");
				Output.Print("b", "c", " Массив чисел случйной длины со случайным наполнением:".PadRight(99)+ "\n");
